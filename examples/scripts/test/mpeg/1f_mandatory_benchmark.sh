...
###
 ...
 # @LastEditTime: 2025-10-07 17:29:45
 # @FilePath: /UniGSC/scripts/test/mpeg/1f_mandatory_benchmark.sh
 # @Description: 
 # 
...
run_experiment() {
    ...
    local result_dir="results/${ply_dir#data}/frame${FRAME_NUM}/${CONFIG_DIR}_shN_PCA_21"
...
run_sequence() {
    ...
    python utils/summary/summarize_stats.py --results_dir "results/${ply_dir#data}/frame${FRAME_NUM}/${CONFIG_DIR}_shN_PCA_21"
}
