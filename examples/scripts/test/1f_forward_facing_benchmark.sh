...
###
 ...
 # @LastEditTime: 2025-11-01 21:43:01
 # @FilePath: /UniGSC/examples/scripts/test/1f_forward_facing_benchmark.sh
 # @Description: 
 # 
...
wait
echo "[INFO] All forward-facing benchmark experiments are completed."