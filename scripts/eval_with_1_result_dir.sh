...
###
 ...
 # @LastEditTime: 2025-09-28 17:47:20
 # @FilePath: /VGSC/scripts/eval_with_1_result_dir.sh
 # @Description: 
 # 
...
if [ "$#" -ne 3 ]; then
    ...
    echo "  result_dir: path to the directory containing configuration files"
    echo "Example: $0 1 bartender configs/video_ffmpeg/anchor_0.0/rp01"
    exit 1
fi
...
ORI_RENDER_DIR=$(echo "$PLY_DIR" | sed 's|^data|renders/gsplat|')
